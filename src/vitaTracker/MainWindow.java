...
public class MainWindow extends JFrame implements ActionListener, WindowListener, ItemListener
{
	 ...
	 * erste Spalte bekommt die Strings f�r den Tabellenheader.
	 */
	...
	/**
	 * erzeugt ein neues WindowTableModel und setzt das WindowTableModel der tblMessung, was auch eine Neuzeichnung der Tabelle ausl�st.
	...
	/**
	 * Hilfsmethode zum bef�llen der JTable
	 */
	...
	/**
	 * 
	 * Bef�llt ein Object[][] mit Attributen von Messungsobjekten, die in einer LinkedList vorgehalten werden.
	 * 
	 * @param src die LinkedList<Messung>() als Quelle f�r die Daten
	 * @param target das Object[][] als Ziel
	 * @return das bef�llte Object[][]
	 */
	 ...
	 * @return das Object[][] das neben dem Header f�r die Tabelle nur noch die Messungsobjekte mit der gesuchten mID haben
	 */
	...
	/**
	 * Erweitert ein �bergebenes Object[][]
	...
	/**
	 * TODO: zeigen!
	 * erzeugt ein Messungsobjekt, unter Ber�cksichtigung des Ausgew�hlten indexes der cBoxMessArt 
	 * und der ausgew�hlten Messungseinheit in cBoxMsngUnit.
	 */
	...
	/**
	 * f�gt ein Messungsobjekt zur LinkedList<Messung> liLiMessungen hinzu
	 * @param m das hizuzuf�gende Messungsobjekt
	 */
			...
			while( in.hasNext() )
			{
				...
				case BLUTZUCKER:
					this.mObjMessung = new Messung(
							...
							Double.parseDouble(splitted[1]),
							Double.parseDouble(splitted[2]),
							splitted[3].intern(), //sonst nix geht unitconversion.
							messArtEnum.blutZucker);
	...
	/**
	 * 
	 * @param das zu setzende Messdatum, zur �bergabe an das tfMessZeit Textfeld.
	 */
